...
def get_args():
    ...
    parser.add_argument('--out-dir', default='train_resnet', type=str, help='Output directory')
...
def main():
    ...
    for epoch in range(args.epochs):
        ...
        torch.save(model.state_dict(), os.path.join(args.out_dir, 'model'+str(epoch)+'.pth'))
