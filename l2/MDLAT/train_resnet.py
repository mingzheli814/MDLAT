...
parser.add_argument('--epsilon', default=0.502,
                    help='perturbation')
parser.add_argument('--num-steps', default=10,
                    help='perturb number of steps')
parser.add_argument('--step-size', default=0.059,
...
def train(args, model1, model2, device, train_loader, optimizer, epoch):
    model1.train()
    model2.train()
...
def main():
    ...
    optimizer = optim.SGD(itertools.chain(model1.parameters(), model2.parameters()), lr=args.lr, momentum=args.momentum, weight_decay=args.weight_decay)   
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        train(args, model1, model2, device, train_loader, optimizer, epoch)


        print('================================================================')

        natural_err_total, robust_err_total = eval_adv_test_whitebox(model1, device, test_loader)
